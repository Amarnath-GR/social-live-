...
class _CreatorStorefrontScreenState extends State<CreatorStorefrontScreen> {
  ...
  Future<void> _loadCreatorProducts() async {
    ...
    try {
      final result = await MarketplaceService.getCreatorProducts(widget.creatorId);
      if (result['success'] == true) {
        setState(() => _products = List<dynamic>.from(result['data']));
      } else {
        setState(() => _errorMessage = result['message'] ?? 'Failed to load products');
      }
    } catch (e) {
