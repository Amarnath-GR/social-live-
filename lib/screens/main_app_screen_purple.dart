...
import 'simple_profile_screen_purple.dart';
import 'real_wallet_screen.dart';
import 'real_marketplace_screen.dart';
import 'enhanced_simple_camera_screen.dart';
import '../services/button_actions_service.dart';

class MainAppScreenPurple extends StatefulWidget {
  @override
  _MainAppScreenPurpleState createState() => _MainAppScreenPurpleState();
}

class _MainAppScreenPurpleState extends State<MainAppScreenPurple> {
  int _currentIndex = 0;
  ...
  void initState() {
    ...
    _screens = [
      ...
      RealMarketplaceScreen(), // Index 1 - Shop
      EnhancedSimpleCameraScreen(), // Index 2 - Camera/Create
      RealWalletScreen(), // Index 3 - Wallet
      SimpleProfileScreenPurple(), // Index 4 - Profile
    ];
  }
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(
            ...
            child: Text('Exit', style: TextStyle(color: Colors.purple)),
          ),
        ],
      ),
    ) ?? false;
    ...
    return AppBar(
      ...
      actions: [
        IconButton(
          ...
          onPressed: () => ButtonActionsService.searchContent(context),
        ),
        IconButton(
          icon: Icon(Icons.settings, color: Colors.white),
          onPressed: () => ButtonActionsService.openSettings(context),
        ),
      ],
    );
  }
              ...
              children: [
                Positioned(
                  ...
                  child: Container(
                    ...
                    height: 28,
                    decoration: BoxDecoration(
                      color: isActive ? Colors.purpleAccent : Colors.grey[500],
