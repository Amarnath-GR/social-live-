...
class _EnhancedProfileScreenState extends State<EnhancedProfileScreen>
  ...
  Future<void> _loadUserProfile() async {
    ...
    final username = prefs.getString('profile_username') ?? 'myusername';
    final bio = prefs.getString('profile_bio') ?? 'Content Creator';
  ...
  Widget _buildProfileHeader() {
    final username = userProfile?['username'] ?? 'myusername';
    final bio = userProfile?['bio'] ?? 'Content Creator';
  ...
  Future<void> _showEditProfileDialog() async {
    final result = await Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => ProfileEditScreen(
          ...
          currentProfilePicture: userProfile?['avatar'],
        ),
      ),
    );
    ...
    if (result == true) {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Profile updated: $username'),
